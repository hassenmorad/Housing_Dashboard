...
- **Monthly homeownership costs** were calculated as such (with each variable reflecting monthly values): (monthly mortgage payment + homeowners insurance + real estate taxes) - tax deductions
